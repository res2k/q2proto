...
static q2proto_error_t q2pro_extdemo_client_read(q2proto_clientcontext_t *context, uintptr_t io_arg, q2proto_svc_message_t *svc_message);
static q2proto_error_t q2pro_extdemo_client_next_frame_entity_delta(q2proto_clientcontext_t *context, uintptr_t io_arg, q2proto_svc_frame_entity_delta_t *frame_entity_delta);
static uint32_t q2pro_extdemo_pack_solid(q2proto_clientcontext_t *context, const q2proto_vec3_t mins, const q2proto_vec3_t maxs);
static void q2pro_extdemo_unpack_solid(q2proto_clientcontext_t *context, uint32_t solid, q2proto_vec3_t mins, q2proto_vec3_t maxs);
...
q2proto_error_t q2proto_q2pro_extdemo_continue_serverdata(q2proto_clientcontext_t *context, uintptr_t io_arg, q2proto_svc_serverdata_t *serverdata)
{
    ...
    context->features.server_game_api = has_q2pro_extensions_v2 ? Q2PROTO_GAME_Q2PRO_EXTENDED_V2 : Q2PROTO_GAME_Q2PRO_EXTENDED;

    return Q2P_ERR_SUCCESS;
}

static q2proto_error_t q2pro_extdemo_client_read_serverdata(q2proto_clientcontext_t *context, uintptr_t io_arg, q2proto_svc_serverdata_t *serverdata);
static q2proto_error_t q2pro_extdemo_client_read_baseline(q2proto_clientcontext_t *context, uintptr_t io_arg, q2proto_svc_spawnbaseline_t *spawnbaseline);
static q2proto_error_t q2pro_extdemo_client_read_frame(q2proto_clientcontext_t *context, uintptr_t io_arg, uint8_t extrabits, q2proto_svc_frame_t *frame);

static q2proto_error_t q2pro_extdemo_client_read(q2proto_clientcontext_t *context, uintptr_t raw_io_arg, q2proto_svc_message_t *svc_message)
{
...
static q2proto_error_t q2pro_extdemo_client_read_delta_entities(q2proto_clientcontext_t *context, uintptr_t raw_io_arg, q2proto_svc_message_t *svc_message)
{
    memset(svc_message, 0, sizeof(*svc_message));
    ...
    q2proto_error_t err = q2pro_extdemo_client_next_frame_entity_delta(context, io_arg, &svc_message->frame_entity_delta);
...
static void q2pro_extdemo_server_make_entity_state_delta(q2proto_servercontext_t *context, const q2proto_packed_entity_state_t *from, const q2proto_packed_entity_state_t *to, bool write_old_origin, q2proto_entity_state_delta_t *delta);
static void q2pro_extdemo_server_make_player_state_delta(q2proto_servercontext_t *context, const q2proto_packed_player_state_t *from, const q2proto_packed_player_state_t *to, q2proto_svc_playerstate_t *delta);
static q2proto_error_t q2pro_extdemo_server_write(q2proto_servercontext_t *context, uintptr_t io_arg, const q2proto_svc_message_t *svc_message);
static q2proto_error_t q2pro_extdemo_server_write_frame(q2proto_servercontext_t *context, uintptr_t io_arg, const q2proto_svc_frame_t *frame);
static q2proto_error_t q2pro_extdemo_server_write_frame_entity_delta(q2proto_servercontext_t *context, uintptr_t io_arg, const q2proto_svc_frame_entity_delta_t *frame_entity_delta);
static q2proto_error_t q2pro_extdemo_server_write_gamestate(q2proto_servercontext_t *context, q2protoio_deflate_args_t* deflate_args, uintptr_t io_arg, const q2proto_gamestate_t *gamestate);
...
q2proto_error_t q2proto_q2pro_extdemo_init_servercontext(q2proto_servercontext_t *context, const q2proto_connect_t *connect_info)
{
    ...
    context->protocol_version = context->server_info->game_api == Q2PROTO_GAME_Q2PRO_EXTENDED_V2 ? PROTOCOL_VERSION_Q2PRO_CURRENT : PROTOCOL_VERSION_Q2PRO_EXTENDED_LIMITS;
...
static q2proto_error_t q2pro_extdemo_server_write_spawnbaseline(q2proto_servercontext_t *context, uintptr_t io_arg, const q2proto_svc_spawnbaseline_t *spawnbaseline)
{
...
static q2proto_error_t q2pro_extdemo_server_write_playerstate(q2proto_servercontext_t *context, uintptr_t io_arg, const q2proto_svc_playerstate_t *playerstate)
{
    ...
    if((playerstate->delta_bits & Q2P_PSD_GUNFRAME) || (playerstate->gunoffset.delta_bits != 0) || (playerstate->gunangles.delta_bits != 0))
