...
static q2proto_error_t r1q2_client_read(q2proto_clientcontext_t *context, uintptr_t io_arg, q2proto_svc_message_t *svc_message);
static q2proto_error_t r1q2_client_next_frame_entity_delta(q2proto_clientcontext_t *context, uintptr_t io_arg, q2proto_svc_frame_entity_delta_t *frame_entity_delta);
...
static void r1q2_unpack_solid(q2proto_clientcontext_t *context, uint32_t solid, q2proto_vec3_t mins, q2proto_vec3_t maxs);
...
static q2proto_error_t r1q2_client_read_serverdata(q2proto_clientcontext_t *context, uintptr_t io_arg, q2proto_svc_serverdata_t *serverdata);
...
static q2proto_error_t r1q2_client_read(q2proto_clientcontext_t *context, uintptr_t raw_io_arg, q2proto_svc_message_t *svc_message)
{
    ...
    /* There could also be "svc_playerupdate" (23), but that has to be explicitly enabled, and was default-off in R1Q2 anyway,
...
static q2proto_error_t r1q2_client_read_delta_entities(q2proto_clientcontext_t *context, uintptr_t raw_io_arg, q2proto_svc_message_t *svc_message)
{
    memset(svc_message, 0, sizeof(*svc_message));
...
static q2proto_error_t r1q2_client_read_playerstate(uintptr_t io_arg, uint8_t extraflags, q2proto_svc_playerstate_t *playerstate)
{
    uint16_t flags;
...
q2proto_error_t r1q2_client_read_zpacket(q2proto_clientcontext_t *context, uintptr_t io_arg, q2proto_svc_message_t *svc_message)
{
    ...
    CHECKED(client_read, io_arg, q2protoio_inflate_begin(io_arg, &inflate_io_arg));
...
static q2proto_error_t r1q2_client_write_move_delta(q2proto_clientcontext_t *context, uintptr_t io_arg, const q2proto_clc_move_delta_t *move_delta)
{
    uint8_t bits = 0;
    uint8_t buttons = 0;
...
static uint32_t r1q2_pack_solid(q2proto_clientcontext_t *context, const q2proto_vec3_t mins, const q2proto_vec3_t maxs)
{
    return context->protocol_version >= PROTOCOL_VERSION_R1Q2_LONG_SOLID ? q2proto_pack_solid_32_r1q2(mins, maxs) : q2proto_pack_solid_16(mins, maxs);
}
...
static q2proto_error_t r1q2_download_data(q2proto_server_download_state_t *state, const uint8_t **data, size_t *remaining, size_t packet_remaining, q2proto_svc_download_t *svc_download);

static const struct q2proto_download_funcs_s r1q2_download_funcs = {
    .begin = r1q2_download_begin,
...
static q2proto_error_t r1q2_server_write_spawnbaseline(q2proto_servercontext_t *context, uintptr_t io_arg, const q2proto_svc_spawnbaseline_t *spawnbaseline);
static q2proto_error_t r1q2_server_write_download(q2proto_servercontext_t *context, uintptr_t io_arg, const q2proto_svc_download_t *download);
static q2proto_error_t r1q2_server_write_frame(q2proto_servercontext_t *context, uintptr_t io_arg, const q2proto_svc_frame_t *frame);
static q2proto_error_t r1q2_server_write_frame_entity_delta(q2proto_servercontext_t *context, uintptr_t io_arg, const q2proto_svc_frame_entity_delta_t *frame_entity_delta);
...
static q2proto_error_t r1q2_server_write_entity_state_delta(q2proto_servercontext_t *context, uintptr_t io_arg, uint16_t entnum, const q2proto_entity_state_delta_t *entity_state_delta)
{
    uint32_t bits = 0;
...
static q2proto_error_t r1q2_server_write_spawnbaseline(q2proto_servercontext_t *context, uintptr_t io_arg, const q2proto_svc_spawnbaseline_t *spawnbaseline)
{
    ...
    CHECKED(server_write, io_arg, r1q2_server_write_entity_state_delta(context, io_arg, spawnbaseline->entnum, &spawnbaseline->delta_state));
    return Q2P_ERR_SUCCESS;
}
...
static q2proto_error_t r1q2_server_write_playerstate(uintptr_t io_arg, const q2proto_svc_playerstate_t *playerstate, uint8_t *extraflags)
{
    uint16_t flags = 0;
    *extraflags = 0;
    ...
    if (*extraflags & EPS_GUNOFFSET)
    {
        WRITE_CHECKED(server_write, io_arg, i8, q2proto_var_small_offsets_get_char_comp(&playerstate->gunoffset.values, 0));
        WRITE_CHECKED(server_write, io_arg, i8, q2proto_var_small_offsets_get_char_comp(&playerstate->gunoffset.values, 1));
        WRITE_CHECKED(server_write, io_arg, i8, q2proto_var_small_offsets_get_char_comp(&playerstate->gunoffset.values, 2));
    }
    if (*extraflags & EPS_GUNANGLES)
    {
        WRITE_CHECKED(server_write, io_arg, i8, q2proto_var_small_angles_get_char_comp(&playerstate->gunangles.values, 0));
        WRITE_CHECKED(server_write, io_arg, i8, q2proto_var_small_angles_get_char_comp(&playerstate->gunangles.values, 1));
        WRITE_CHECKED(server_write, io_arg, i8, q2proto_var_small_angles_get_char_comp(&playerstate->gunangles.values, 2));
    }
...
static q2proto_error_t r1q2_server_write_frame_entity_delta(q2proto_servercontext_t *context, uintptr_t io_arg, const q2proto_svc_frame_entity_delta_t *frame_entity_delta)
{
    ...
    return r1q2_server_write_entity_state_delta(context, io_arg, frame_entity_delta->newnum, &frame_entity_delta->entity_delta);
}
...
static q2proto_error_t r1q2_server_read_move_delta(q2proto_servercontext_t *context, uintptr_t io_arg, q2proto_clc_move_delta_t *move_delta)
{
    uint8_t bits;
    ...
    move_delta->buttons = buttons & ~(BUTTON_UCMD_DBLFORWARD | BUTTON_UCMD_DBLSIDE | BUTTON_UCMD_DBLUP | BUTTON_UCMD_DBL_ANGLE1 | BUTTON_UCMD_DBL_ANGLE2);
...
static q2proto_error_t r1q2_download_data(q2proto_server_download_state_t *state, const uint8_t **data, size_t *remaining, size_t packet_remaining, q2proto_svc_download_t *svc_download)
{
    ...
    if (state->compress && packet_remaining > SVC_ZDOWNLOAD_SIZE)
    {
        ...
        CHECKED_IO(server_write, deflate_io, q2protoio_write_raw(deflate_io, *data, *remaining, &in_consumed), "write download data");
        *data += in_consumed;
